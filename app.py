...
mydb = MySQLdb.connect(host='localhost',user='root',passwd='',db='banking')
conn = mydb.cursor()
...
def log_in():
        ...
        if request.form['cid'] != None and request.form['cid'] != "" and request.form['pin'] != None and request.form['pin'] != "":
                ...
                if(isRecordExist==1):
                        ...
                        headers = {'authorization':"LjiNJIhAtrEeWfTKFOpsVXmxbDUdo3w2QyP985Mac7ZvYqkC6GozP1te9Frw7b0qYBJQhi4HfXOTVvD8",'Content-Type': "application/x-www-form-urlencoded",'Cache-Control': "no-cache",}
